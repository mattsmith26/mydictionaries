...
# could always make datastore medical a value if you want to make it easier
for line in datastore["medical"]:
  outfile.write(str(line["room-number"]) + ", " + str(line["use"]) + ", " + str(line["sq-ft"]) + ", " + str(line["price"]) + "\n")
